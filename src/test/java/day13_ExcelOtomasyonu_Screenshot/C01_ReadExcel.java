...
public class C01_ReadExcel {
    ...
    public void test01() throws IOException {
        ...
        // ulkeler.xlsx dosyasinda 16.satirdaki ulkenin, turkce isminin Barbados oldugunu test edin.
        ...
        // Excel'de ingilizce ismi Benin olan bir ulke olup olmadigini test edin.
        ...
        int kullanilanSatirSayisi = workbook.getSheet("Sayfa2")
                                            .getPhysicalNumberOfRows();
        int expectedSatirSayisi = 7;
        Assert.assertEquals(expectedSatirSayisi,kullanilanSatirSayisi);

        // Sayfa1'deki tum ulke isimlerini ve tum bilgileri bir Map olarak kaydedin,
